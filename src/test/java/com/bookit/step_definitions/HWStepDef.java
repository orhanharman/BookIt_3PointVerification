...
public class HWStepDef {
    ...
    public void iGetTheCurrentInformationFromUI() {
    ...
    @Then("I get the current user information from database")
    public void iGetTheCurrentUserInformationFromDatabase() {
        ...
        //emailGlobal comes from ApiStepDefs class via inheritance
    ...
    public void all_five_information_from_three_layer_should_match() {
